...
class EditStudent extends React.Component
{
    ...
    componentDidMount(){
        this.setState({FirstName:this.props.studentToUpdate.firstName})
        console.log(this.state.FirstName)
        this.setState({LastName:this.props.studentToUpdate.lastName})
        this.setState({Class:this.props.studentToUpdate.classs})
        this.setState({Division:this.props.studentToUpdate.div})
        this.setState({AddressLine1:this.props.studentToUpdate.line1})
        this.setState({AddressLine2:this.props.studentToUpdate.line2})
        this.setState({pincode:this.props.studentToUpdate.pin})
    }
    ...
    render()
    {
        ...
        return(
            ...
            <h4> Student To be edit:</h4> <h2>{this.props.studentToUpdate.studentID} </h2>
                ...
                <InputBox ref="fname" inputType={this.props.inputType} placeholder={this.props.placeholder} defaultValue={this.props.value }   value={this.props.studentToUpdate.firstName} 
                                handleChanges={this.handleFirstNameChange} Name="firstName" error={this.state.ErrfirstName} /><br></br> 
                <InputBox ref="lname" inputType="text" placeholder="Last Name" value={this.props.studentToUpdate.lastName} 
                                handleChanges={this.handleLastNameChange} Name="lastName" error={this.state.ErrlastName} /><br></br> 
                <InputBox ref="cls" inputType="text" placeholder="Class" value={this.props.studentToUpdate.classs} 
                                handleChanges={this.handleClassChange} Name="class" error={this.state.ErrClass} /><br></br> 
                <InputBox ref="divi" inputType="text" placeholder="Division" value={this.props.studentToUpdate.division} 
                                handleChanges={this.handleDivisionChange} Name="division" error={this.state.Errdivision} /><br></br> 
                <InputBox ref="addr1" inputType="text" placeholder="Address Line1" value={this.props.studentToUpdate.line1} 
                                handleChanges={this.handleAddressLine1Change} Name="addressLine1"error={this.state.ErraddressLine1} /><br></br> 
                <InputBox ref="addr2" inputType="text" placeholder="Address Line2" value={this.props.studentToUpdate.line2} 
                                handleChanges={this.handleAddressLine2Change} Name="addressLine2" /><br></br> 
                <InputBox ref="pin" inputType="text" placeholder="PIN code" value={this.props.studentToUpdate.pinCode} 
